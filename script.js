...
var resumeString = "<img src='images/resumeThumbnail.png' class='resumeThumbnail'><div class='downloadSpace'><div class='pdfname'><img src='images/pdf.png'><label>Kartik_Sharma_Resume.pdf</label></div><a href='assets/Kartik_Sharma_Resume.pdf' download='Kartik_Sharma_Resume.pdf'><img class='download' src='images/downloadIcon.svg'></a></div>";
...
function waitAndResponce(inputText) {
    ...
    switch (inputText.toLowerCase().trim()) {
        ...
        case "help":
            ...
            break;
        case "profiles":
            sendTextMessage("You can find me on : <br> <a class='alink' target='_blank' href='https://www.leetcode.com/atninthsky'><span class='bold'>Leetcode</a> <br> <a class='alink' target='_blank' href='https://www.codechef.com/users/itwasme'><span class='bold'>Codechef</a> <br> <a class='alink' target='_blank' href='https://codeforces.com/profile/decoder001'><span class='bold'>Codeforces</a> <br> <a class='alink' target='_blank' href='https://www.hackerrank.com/skartiksharma201'><span class='bold'>HackerRank</a>  <br> <a class='alink' target='_blank' href='https://www.github.com/dartpixel'><span class='bold'>Github</a> <br> <a class='alink' target='_blank' href='https://linkedin.com/in/kartiksharma2004'><span class='bold'>Linkedin</a> ");
            break;
        case "resume":
        ...
        case "address":
            ...
            break;
        case "about":
            sendTextMessage("🛠️💻 This portfolio website is built using HTML, CSS and JavaScript from SCRATCH!<br><br>👨🏻‍💻 Designed and Developed with ❤️ by <a class='alink' target='_blank' href='https://linkedin.com/in/kartiksharma2004'><span class='bold'>Kartik Sharma</a></span>");
            break;
        case "clear":
            clearChat();
            break;
        case "contact":
            ...
            break;
        case "projects":
            sendTextMessage("You want to check my projects? Then just jump into my Github Account.<br><br><div class='social'><a target='_blank' href='https://github.com/dartpixel'> <div class='socialItem'><img class='socialItemI' src='images/github.svg' alt=''></div> </a></div>");
            break;
        case "new":
